...
const WAITLIST = [
  ...
  { id: 'w3', patient: 'Can Arslan',   department: 'Psikoloji',      timeOfDay: 'any',        channel: 'voice',    position: 1, phone: '+90 555 300 4040', dateRange: '18–24 Mayıs 2026' },
  { id: 'w4', patient: 'Derya Çelik',  department: 'Diyetetik',      timeOfDay: 'morning',   channel: 'whatsapp', position: 2, phone: '+90 506 400 5050', dateRange: '19–21 Mayıs 2026' },
];
          ...
          <div className="rdv-waitlist-list">
            {WAITLIST.map(w => (
              <div key={w.id} className="rdv-waitlist-card">
                ...
                <button className="rdv-wl-notify">
                  Bildirim Gönder
                </button>
              </div>
            ))}
